...
export const config = {
  ...
  // making it invisible outside the container. Without this, Render's
  // automatic port scanner can detect the backend's own port and route
  // public traffic there instead of to the frontend, since it opens later
  // (after migrate+seed) — see the 502 investigation this fixed.
